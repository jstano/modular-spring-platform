...
class AES256EncryptedBytesFactoryTest {
    ...
    void withPlainBytesShouldReturnInstanceOfAES256EncryptedBytesAndShouldWork() {
        ...
        assertThat(factory.withClearBytes("abc123".getBytes())).isInstanceOf(AES256EncryptedBytes.class);
        assertThat(factory.withClearBytes("abc123".getBytes()).getClearBytes()).isEqualTo("abc123".getBytes());
    }
    ...
    void withEncryptedBytesShouldReturnInstanceOfAES256EncryptedBytesAndShouldWork() {
        ...
        assertThat(factory.withEncryptedBytes(encryptedBytes).getClearBytes()).isEqualTo("abc123".getBytes());
    }
}
