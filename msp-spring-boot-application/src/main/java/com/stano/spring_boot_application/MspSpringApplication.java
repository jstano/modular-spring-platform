...
public class MspSpringApplication {
  ...
  public static ConfigurableApplicationContext run(Class<?> primarySource, String... args) {
    ...
    if (hasMigrateFlag(args)) {
      SchemaMigrationRequestedEvent event =
          new SchemaMigrationRequestedEvent(MspSpringApplication.class);
      ...
      if (event.isHandled()) {
        ...
        LOGGER.warn(
            "Schema migration requested (--migrate) but no migration handler is registered. "
