...
dependencies {
  ...
  api(platform("com.stano:schema-bom:0.55.0"))
...
//    api("com.github.ben-manes.caffeine:caffeine:3.2.4")
    ...
    api("io.opentelemetry.javaagent:opentelemetry-javaagent:2.29.0")
    api("io.opentelemetry.instrumentation:opentelemetry-logback-appender-1.0:2.29.0-alpha")
