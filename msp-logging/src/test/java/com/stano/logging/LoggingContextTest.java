...
class LoggingContextTest {
  ...
  @Test
  void
      theMdcShouldHaveTheValuesFromTheNewContextAfterSetupContextIsCalledAndBeforeRestoreContextIsCalled() {
    MDC.put("key1", "abc");
    MDC.put("key2", "def");
    MDC.put("key3", "ghi");
  ...
  @Test
  void
      theMdcShouldHaveTheValuesFromThePriorContextRestoredAfterSetupContextAndRestoreContextAreCalled() {
    MDC.put("key1", "abc");
    MDC.put("key2", "def");
    MDC.put("key3", "ghi");

    var loggingContext =
        LoggingContext.newContext().with("key1", "ABC").with("key2", "XYZ").with("key4", "JHG");
